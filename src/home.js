...
const renderTasks = (e, project, projectManager) => {
  ...
  manipulateDOM().refresh_todo_list_display(todo_list, project, projectManager);
  manipulateDOM().create_add_task_button(todo_list, project, projectManager);
