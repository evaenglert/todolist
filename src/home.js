...
const renderTasks = (e, project_name, project, all_projects, projectManager) => {
  ...
  manipulateDOM().create_add_task_button(todo_list, project, all_projects, projectManager);
